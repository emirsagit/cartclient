<template>
  <div class="bg-teal-800 min-h-screen px-2 py-4 md:px-0">
    <header class="max-w-lg mx-auto">
      <h1 class="text-4xl font-bold text-white text-center">Kayıt Ol</h1>
    </header>
    ...
    >
      <section>
        ...
        <p class="text-gray-600 pt-2">
          Aşağıdaki formu kullanarak kayıt olabilirsiniz.
        </p>
      </section>

      <section class="mt-10">
        <form class="flex flex-col" method="POST" @submit.prevent="register">
          <div class="mb-6 pt-3 rounded bg-gray-200">
            ...
            />
            <p class="text-sm text-red-600 pl-3" v-if="errors.name">
              {{ errors.name[0] }}
            </p>
          </div>
          <div class="mb-6 pt-3 rounded bg-gray-200">
